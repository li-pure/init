...
# e1,e2 for build the rotational geometry
...
if compute_flux:
    tran = sim.add_flux(fsrc, 0, 1, mp.FluxRegion(center=mp.Vector3(x=5), size=mp.Vector3(y=14)))     # Type: DftFlux
    ...
    # 1106.159095, 1108.333666
    # compare two methods' power
